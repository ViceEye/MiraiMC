...
public class MiraiGroupTempMessagePostSendEvent extends PluginEvent {

    public MiraiGroupTempMessagePostSendEvent(Plugin plugin, GroupTempMessagePostSendEvent event) {
        super(plugin);
        this.event = event;
    }
