...
public class MiraiGroupTempMessagePreSendEvent extends PluginEvent {

    public MiraiGroupTempMessagePreSendEvent(Plugin plugin, GroupTempMessagePreSendEvent event) {
        super(plugin);
        this.event = event;
    }
