...
public class MiraiStrangerMessagePreSendEvent extends PluginEvent {

    public MiraiStrangerMessagePreSendEvent(Plugin plugin, StrangerMessagePreSendEvent event) {
        super(plugin);
        this.event = event;
    }
